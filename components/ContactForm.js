  ...
  return (
    <>
      <div className={`centerContent flex-col contactForm w-full md:pb-16 mt-8 md:mt-32 px-6 lg:px-0`}>
        <p className='text-3xl md:text-4xl font-bold uppercase mb-8 tracking-wide border-b border-opacity-20 border-secondary-500 pb-4 px-4 text-center'>
          contact / booking
        </p>
          ...
          <form className='w-full'>
            ...
            <div className='flex flex-wrap -mx-3 mb-2'>
              <div className='w-full px-3 mb-2 md:mb-0'>
                ...
                <textarea
                  rows='7'
                  className={`resize-none md:resize-y appearance-none block w-full bg-gray-200 text-gray-700 border border-secondary-500 border-opacity-20 rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-primary-500 ${!messageIsValid && 'border-red-500'
                    }`}
                  id='grid-first-name'
                  type='text'
