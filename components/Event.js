    ...
    <>
      ...
      >
        ...
        <div className='centerContent'>
          <div className='centerContent w-[150px] h-12 rounded-lg bg-secondary-500 shadow text-primary-500 hover:cursor-pointer'>
      ...
      <div
        className={`mt-4 ${
          !last && 'mb-4'
        } md:hidden centerContent py-6 max-w-[1400px] w-full flex flex-col gap-6 rounded-lg`}
      >
