...
export default function DownloadItem({ title, filename, link = '' }) {
  return (
    <div className='flex items-center justify-between gap-8 p-6 md:p-8 min-h-[90px] cursor-pointer w-full border-l-8 border-accent-500  rounded-lg bg-primary-500 shadow-md hover:bg-accent-500 hover:text-primary-500 active:scale-[0.97] duration-150'>
